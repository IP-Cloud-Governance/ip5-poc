...
async def post_project(
    ...
    project = ProjectContext(
        ...
        azure_paths=[
            CloudPlattformPath(id=uuid.uuid4(), path=p, plattform=CloudPlattform.AZURE)
            for p in project_context.azure_paths
        ],
        aws_paths=[
            CloudPlattformPath(id=uuid.uuid4(), path=p, plattform=CloudPlattform.AWS)
...
async def get_project(
    ...
    return ProjectContext.model_validate(project).model_dump(
